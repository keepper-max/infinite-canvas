export default {
    ...
    auth: {
        ...
        forgotPasswordHint: "Verify your account email and set a new password.",
        email: "Email",
        password: "Password",
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", mode: "Generation mode", modes: { frames: "First & last frame", reference: "Multimodal reference", t2v: "Text to video", i2v: "First frame", flf2v: "First & last frame", multiref: "Multimodal reference" }, modeHints: { t2v: "Uses the prompt only and does not submit references.", i2v: "Requires one first-frame image.", flf2v: "Requires one first-frame and one last-frame image.", multiref: "Accepts image, video, or audio references." }, bitrateMode: "Bitrate", outputFormat: "Output format", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", extensionRatioHint: "Video extensions inherit the input video's aspect ratio.", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    videoWorkbench: {
        ...
        noReferencesForMode: "The current generation mode does not use reference images.",
    ...
    canvas: {
        ...
        sidePanel: {
            ...
            virtualPortraitHint: "Virtual character assets", refreshVirtualPortraits: "Refresh virtual character status", noVirtualPortraits: "No virtual character assets", virtualPortraitCreated: "Virtual character asset submitted", virtualPortraitCreateFailed: "Could not create virtual character asset", virtualPortraitRemoved: "Virtual character asset removed", virtualPortraitRemoveFailed: "Could not remove virtual character asset", removeVirtualPortraitTitle: "Remove this virtual character asset?", virtualPortraitStatus: { processing: "Processing", active: "Ready", failed: "Failed" },
        ...
        references: { title: "References", select: "Select references from canvas", disconnect: "Disconnect reference", empty: "No content", selecting: "Adding references", cancelSelecting: "Cancel adding reference", choose: "Select reference", selectingHint: "Select one reference to return · Click here or press ESC to cancel", noneAvailable: "No references are available. Add an image, video, audio, or text asset first." },
