export default {
    ...
    canvas: {
        ...
        sidePanel: {
            ...
            virtualPortraitHint: "Token360 虚拟角色资产", refreshVirtualPortraits: "刷新虚拟角色状态", noVirtualPortraits: "暂无虚拟角色资产", virtualPortraitCreated: "虚拟角色资产已提交", virtualPortraitCreateFailed: "虚拟角色资产创建失败", virtualPortraitRemoved: "虚拟角色资产已移除", virtualPortraitRemoveFailed: "虚拟角色资产移除失败", removeVirtualPortraitTitle: "移除该虚拟角色资产？", virtualPortraitStatus: { processing: "处理中", active: "可使用", failed: "处理失败" },
