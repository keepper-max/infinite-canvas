export default {
    ...
    auth: {
        ...
        forgotPasswordHint: "验证注册邮箱后设置新密码。",
        email: "邮箱",
        password: "密码",
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", mode: "生成方式", modes: { frames: "首尾帧模式", reference: "多模态参考", t2v: "文生视频", i2v: "首帧图生", flf2v: "首尾帧图生", multiref: "多模态参考" }, modeHints: { t2v: "只使用提示词，不提交参考素材。", i2v: "需要 1 张首帧图。", flf2v: "需要首帧和尾帧各 1 张。", multiref: "可使用图片、视频或音频作为参考素材。" }, bitrateMode: "码率", outputFormat: "输出格式", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", extensionRatioHint: "视频延长时，输出比例跟随输入视频。", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    videoWorkbench: {
        ...
        noReferencesForMode: "当前生成方式不需要参考图",
    ...
    canvas: {
        ...
        node: {
            node: "节点",
            untitled: "未命名节点", renameHint: "双击修改节点名称", group: "组", nodeCount: "{{count}} 个节点", generating: "生成中", failed: "生成失败", retry: "重试", missingPlugin: "缺少插件", missingPluginDescription: "节点类型“{{type}}”的插件未安装或未启用", generateImage: "用文本生图", generate: "生图", editText: "双击编辑文字", emptyImage: "空图片节点", assetNotLoaded: "素材未载入", reloadAsset: "重新载入", assetReloaded: "素材已重新载入", assetReloadFailed: "素材重新载入失败", emptyVideo: "空视频节点", emptyAudio: "空音频节点", audio: "音频", batchExpanded: "图片组已展开", batchCollapsed: "图片组已收起", textBatchExpanded: "备选文本已展开", textBatchCollapsed: "备选文本已收起", createCopy: "创建副本", setPrimary: "设为主图", setPrimaryText: "设为主文本",
        },
        ...
        sidePanel: {
            canvas: "画布", assets: "资产", virtualPortraits: "虚拟角色", prompts: "提示词库", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
            ...
            virtualPortraitHint: "虚拟角色资产", refreshVirtualPortraits: "刷新虚拟角色状态", noVirtualPortraits: "暂无虚拟角色资产", virtualPortraitCreated: "虚拟角色资产已提交", virtualPortraitCreateFailed: "虚拟角色资产创建失败", virtualPortraitRemoved: "虚拟角色资产已移除", virtualPortraitRemoveFailed: "虚拟角色资产移除失败", removeVirtualPortraitTitle: "移除该虚拟角色资产？", virtualPortraitStatus: { processing: "处理中", active: "可使用", failed: "处理失败" },
        ...
        references: { title: "参考内容", select: "从画布选择参考节点", disconnect: "断开参考连接", empty: "暂无内容", selecting: "正在添加参考", cancelSelecting: "取消添加参考", choose: "选择此参考", selectingHint: "选择一个参考后自动返回 · 点击此处或按 ESC 取消", noneAvailable: "画布中暂无可用参考，请先添加图片、视频、音频或文本素材" },
