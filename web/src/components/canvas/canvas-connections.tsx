...
const ROLE_COLORS: Partial<Record<NonNullable<CanvasConnection["role"]>, string>> = {
    identity: "#f59e0b",
    environment: "#10b981",
    composition: "#a855f7",
    motion: "#ec4899",
        ...
        <g>
            ...
            {active && connection.role && connection.role !== "data" ? (
                <g style={{ pointerEvents: "none" }}>
                    ...
                    <text x={(startX + endX) / 2} y={(startY + endY) / 2 + 4} textAnchor="middle" fill={theme.node.text} fontSize="10">
                        {connection.role}
                    </text>
                </g>
            ) : null}
