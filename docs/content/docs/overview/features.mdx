...
- Administrators can switch the managed canvas provider; ordinary users only see the selected provider's available text, image, audio, and video models and never receive provider credentials.
